                    ...
                    <div className="bg-white rounded-2xl shadow-2xl border-t-4 border-green-500 overflow-hidden transform hover:scale-[1.01] transition-transform duration-300">
                        <div className="p-6">
                            ...
                            <form onSubmit={sendToWhatsApp} className="space-y-4">
                                ...
                                <button 
                                    type="submit" 
                                    className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-4 rounded-xl shadow-lg shadow-green-500/20 transition-all flex items-center justify-center gap-2 mt-4"
                                >
