      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left">
        <div className="sm:max-w-2xl">
          ...
          <p className="text-lg sm:text-xl text-slate-300 mb-8 font-light leading-relaxed">
            Solicite uma consultoria personalizada e descubra quanto você ou sua empresa pode lucrar economizando com a tecnologia VTS. Projetos comerciais, industriais e residenciais via App Pro.
          </p>
